...
#define SerialGPS SoftwareSerial2
...
#define AXIS1_STEPS_PER_DEGREE    13107.2 // 10240 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT     32768 // 25600 //      0, n. Number steps per worm rotation (PEC Eq mode only, 0 disables PEC.)   <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    13107.2 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS4_STEPS_PER_MICRON        3.6 //1.8 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
#define AXIS4_SLEW_RATE_DESIRED      1000 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr %   Adjust

#define AXIS4_DRIVER_MODEL        TMC2209 //    OFF, TMC2130, TMC5160. Leave OFF for all drivers models except these.         Option
...
#define AXIS5_STEPS_PER_MICRON        3.6 // 1.8 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
#define AXIS5_SLEW_RATE_DESIRED      1000 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr %   Adjust

#define AXIS5_DRIVER_MODEL        TMC2209 //    OFF, TMC2130, TMC5160. Leave OFF for all drivers models except these.         Option
#define AXIS5_DRIVER_MICROSTEPS         8 //    OFF, n. Microstep mode when tracking.                   For TMC2130, TMC5160. Option
...
#define FEATURE1_NAME            "MIROIR" // "FE..", Name of feature being controlled.                                        Adjust
...
#define FEATURE4_NAME         "12VCAMERA" // "FE..", Name of feature being controlled.                                        Adjust
...
// Park signal settings
#define PARK_SIGNAL                  ON_PULLUP  //SCL ON, ON_PULLUP, OFF, HIGH or LOW state park input signal triggers parking.                    Option
#define PARK_SIGNAL_STATE            LOW       // HIGH, LOW, OFF
