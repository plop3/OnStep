...
#define Aux7                 19     // Limit SW, PPS, etc.
#define Aux8                 33     // 23     // OneWire, Status LED, Status2 LED, Reticle LED, etc.

// Misc. pins
#ifndef OneWirePin
  #define OneWirePin         32     // Aux8     // Default Pin for OneWire bus
#endif
...
#define LEDnegPin             2     // Aux8     // Drain
#define LEDneg2Pin         Aux8     // Drain
#define ReticlePin         Aux8     // Drain

// For a piezo buzzer
#define TonePin              15     // 2     // Tone

// The PPS pin is a 3.3V logic input, OnStep measures time between rising edges and adjusts the internal sidereal clock frequency
#define PpsPin               36     // Aux7     // PPS time source, GPS for example
...
#define Axis1_EN             23     // Enable [must be low at boot 12]
...
#define Axis4_EN             12     // Enable pin control shared with Axis1
...
#define PARK_SIGNAL_PIN	     12	    // SCL Pin ordre de park
