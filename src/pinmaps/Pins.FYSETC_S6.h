...
// Misc. pins
  ...
  #define BME280_CS_PIN     PA4 // PC7     // Default CS Pin for BME280 on SPI (on EXP2 shared with LED2/Reticle)
#endif
#ifndef OneWirePin
  #define OneWirePin        PE0     // Default Pin for OneWire bus (on E2-MOT PD-EN, right hand pin)
#endif
#define AddonBootModePin    PC6 // PD0     // ESP8266 GPIO0 (on EXP1)
#define AddonResetPin       PC7 // PA4     // ESP8266 RST (on EXP2 shared with the DS3234 CS pin)
...
#define LEDnegPin           PB14 // PC6     // Drain (on EXP2) One could perhaps move these to the RGB leds, there's a header but no +5V present on it.
...
// For a piezo buzzer
#define TonePin             PB13 //PC9     // Tone (on BEEP/EXP1)
...
#define PARK_SIGNAL_PIN     PD0 // PA2     // SCL Pin ordre de park
